---
name: godot-shader
description: Author Godot 4.x .gdshader files for 2D canvas_item effects, 3D spatial materials, particles, and post-processing. Use when writing or debugging shaders.
---
