---
name: godot-code-gen
description: GDScript 4.x best practices — type hints, signals, state machines, async/await, tweens, and project structure. Use when writing or reviewing .gd scripts for Godot 4.
---
