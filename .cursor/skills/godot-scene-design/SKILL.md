...
description: Design and author Godot 4.x .tscn scenes, node hierarchies, collision layers, and level layouts. Use when creating or editing scenes, PackedScenes, or scene trees.
---
