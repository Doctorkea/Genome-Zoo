...
description: Lightweight live-editor guidance via Godot AI Bridge for real-time inspect and edit. Use when controlling a running Godot editor without the full godot-interactive MCP session workflow.
---
