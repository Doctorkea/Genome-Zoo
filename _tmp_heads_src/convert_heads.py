...
JOBS = [
    ("head_cockatoo.jpg", "head_cockatoo.png"),
    ("head_turtle.jpg", "head_turtle.png"),
    ("head_lizard.jpg", "head_lizard.png"),
    ("head_frog.jpg", "head_frog.png"),
    ("head_hamster.jpg", "head_hamster.png"),
    ("head_duck.jpg", "head_duck.png"),
    ("head_lion.jpg", "head_lion.png"),
    ("head_gorilla.jpg", "head_gorilla.png"),
]
...
def is_paper(rgb: np.ndarray) -> np.ndarray:
    ...
    pale = (lum >= 228) & (sat < 0.20)
    near_white = (lum >= 242) & (sat < 0.28)
    return pale | near_white
...
def convert(src: Path, dest: Path) -> None:
    ...
    print(f"{dest.name}: opaque={int(solid.sum())} outline={int(outline.sum())} fill={int(fill.sum())}")
